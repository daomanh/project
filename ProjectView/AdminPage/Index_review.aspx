<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage/Admin_masterPage.Master" AutoEventWireup="true" CodeBehind="Index_review.aspx.cs" Inherits="ProjectView.AdminPage.Index_review" %>
                    ...
                    <asp:Repeater ID="theID" runat="server" OnItemCommand="theID_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="area" Text='<%#Eval("totalReview") %>'></asp:Label>
                                </td>
